/*--------------------------------------------------------------------------------
 * DH3DLibrary CameraMotionBank.js v0.2.0
 ...
 *
 *------------------------------------------------------------------------------*/
var CameraMotionBank = Class.create({
  _motions: $H(),
  _loadingMotions: $H(),
  _motionReaders: $A(),
  ...
  getMotion: function(motionFile, options) {
    ...
    if(motion){
      motion.onload = function(){ CameraMotionBank.onloadMotion(motion); };
...
CameraMotionBank = new CameraMotionBank();
