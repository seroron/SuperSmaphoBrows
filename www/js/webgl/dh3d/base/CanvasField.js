...
var CanvasField = Class.create({
  ...
  _callNextFrame: function() {
    var obj = this;
    if(this._requestAnimationFrame){
      this._requestAnimationFrame.call(window, function() { obj.drawPicture(); } );
    }else{
      var interval = this._spf - this._elapsedTime;
      if(interval < this._minInterval){
        interval = this._minInterval;
      }
      window.setTimeout(function(){ obj.drawPicture(), interval * 1000 });
    }
  },
